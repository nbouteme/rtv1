...
/*   Updated: 2016/08/01 23:53:05 by nbouteme         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_ray gen_camray(int x, int y, t_vec3 pos, t_vec3 dir)
{
	...
	float viewPlaneHalfWidth = tan(M_PI / 4);
	...
	ft_memcpy(v, vec3_muls(v, viewPlaneHalfHeight), sizeof(t_vec3));
	ft_memcpy(u, vec3_muls(u, viewPlaneHalfWidth), sizeof(t_vec3));

	ft_memcpy(tmp3, vec3_sub(v, u), sizeof(t_vec3));
	ft_memcpy(viewPlaneBottomLeftPoint, vec3_sub(lap, tmp3), sizeof(t_vec3));

	ft_memcpy(v, vec3_muls(v, 2.0f), sizeof(t_vec3));
	ft_memcpy(u, vec3_muls(u, 2.0f), sizeof(t_vec3));

	ft_memcpy(v, vec3_muls(v, 1.0f / 720.0f), sizeof(t_vec3));
	ft_memcpy(u, vec3_muls(u, 1.0f / 1280.0f), sizeof(t_vec3));
	...
	ft_memcpy(tmp2, vec3_add(tmp2, tmp1), sizeof(t_vec3));

	ft_memcpy(ppoint, vec3_add(viewPlaneBottomLeftPoint, tmp2), sizeof(t_vec3));
