...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/09/18 00:25:30 by nbouteme          #+#    #+#             */
/*   Updated: 2016/09/18 00:25:31 by nbouteme         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <libft/parser.h>

t_parser	*regex_engine(void)
{
	t_parser *regex;
	t_parser *term;
	t_parser *factor;
	...
	assign_parser(factor, and_parser(delete_parser, fold_rep, 2, (t_parser*[]){
		base, or_parser(4, (t_parser*[]){	char_parser('*'),
											char_parser('+'),
											char_parser('?'),
											nothing_parser() })}));
